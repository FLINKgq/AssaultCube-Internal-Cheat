...
namespace ImGui
{
    ...
    // - Speed are per-pixel of mouse movement (v_speed=0.2f: mouse needs to move by 5 pixels to increase value by 1). For keyboard/gamepad navigation, minimum maxSpeed is Max(v_speed, minimum_step_at_given_precision).
...
enum ImGuiSliderFlags_
{
    ...
    ImGuiSliderFlags_NoSpeedTweaks      = 1 << 11,      // Disable keyboard modifiers altering tweak maxSpeed. Useful if you want to alter tweak maxSpeed yourself based on your own logic.
